...
var userSchema = new mongoose.Schema({
  ...
  password: {
    ...
    validate: [
      utils.buildSchemaValidator(
        'password',
        'Passwort muss zwischen vier und 50 Zeichen lang sein.',
        function(password) {
  ...
  bio: {
    source: {
      ...
      validate: [
        utils.buildSchemaValidator(
          'bio.source',
          'Biografie darf nicht nur aus Leerzeichen bestehen.',
          function(bio) {
            if(!bio)
              return true
        ...
        utils.buildSchemaValidator(
          'bio.source',
          'Biografie darf nicht länger als ' + config.profile.bio.maxLength + ' Zeichen sein.',
          function(bio) {
