...
var postSchema = new mongoose.Schema({
  ...
  title: {
    ...
    minlength: [1, 'Name muss mindestens ein Zeichen lang sein.'],
  ...
  text: {
    source: {
      ...
      validate: [
        {
          msg: 'Text darf nicht nur aus Leerzeichen bestehen.',
          validator: utils.buildSchemaValidator('text.source', function(text) {
            if(!text)
              return true
