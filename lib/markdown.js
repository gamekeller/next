...
exports.plugins.linkClass = function linkClass(md) {
  md.core.ruler.push('link_class', function(state) {
    function applyClass(token) {
      ...
      if(token.type === 'link_open' && token.attrGet('href') && !token.attrGet('class')) {
...
var markdowns = exports.markdowns = {
  standard: renderer(),
  anchoredHeadings: renderer()
    .use(exports.plugins.linkClass)
    .use(require('markdown-it-implicit-figures'), { figcaption: true })
    .use(require('markdown-it-attrs'))
    .use(MarkdownItAnchor, exports.anchorHeadingsOptions)
}
